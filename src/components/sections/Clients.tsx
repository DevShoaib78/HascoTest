...
export default function Clients() {
  ...
  const clients = [
    ...
    { name: "saudi-aramco", logoImage: "https://upload.wikimedia.org/wikipedia/en/thumb/a/a7/Saudi_Aramco_logo.svg/1920px-Saudi_Aramco_logo.svg.png" },
    ...
    <div ref={sectionRef} className="bg-white py-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        ...
        <div className={`text-center mb-20 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <h2 className="text-title-lg md:text-title-xl mb-4 font-heading leading-tight font-bold" style={{ fontWeight: 700 }}>
        ...
        <div className="flex flex-col items-center gap-8 md:gap-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 lg:gap-16 w-full max-w-5xl">
            {clients.slice(0, 3).map((client, index) => (
              <div 
                key={index} 
                className={`group flex items-center justify-center p-8 bg-white rounded-xl border border-gray-100 hover:border-brand-primary/30 hover:shadow-lg transition-all duration-500 ${
              ...
              >
                <div className="relative w-full h-24 flex items-center justify-center">
                  <Image
                    ...
                    className={`object-contain filter grayscale opacity-60 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-500 w-auto ${
                      client.name === 'neom' ? 'max-h-32 scale-125' : 'max-h-20'
                    }`}
                  />
                </div>
              </div>
