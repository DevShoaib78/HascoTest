        ...
        <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-[#004A81] to-gray-900 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-6 font-heading" dir="rtl">
                الصفحة غير موجودة
              </h2>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link
                  href="/ar"
                  className="bg-white text-[#004A81] px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-colors duration-300 font-heading"
                >
                  الرئيسية (AR)
                </Link>
              </div>
